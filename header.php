	...
	<div id="container">
		...
		<header id="masthead" class="cf" role="banner">
			...
			<?php if ( get_header_image() ) : ?>
				<div id="site-header">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php header_image(); ?>" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt="Utställningskritik"></a>
				</div><!-- end #site-header -->
			<?php endif; ?>
